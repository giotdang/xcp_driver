...
static const Xcp_ConfigType *Xcp_ConfigPtr;
...
void Xcp_SendCrm( void )
{
  ...
  Xcp_ConfigPtr->TransportLayer->EnterCritical();
  ...
  else
  {
    ...
    Xcp_ConfigPtr->TransportLayer->Transmit(xcp.CrmLen, &xcp.Crm.b[0]);
  }

  Xcp_ConfigPtr->TransportLayer->ExitCritical();
...
{      
  ...
  else
  {
    ...
    Xcp_ConfigPtr->TransportLayer->Transmit(xcp.EvLen, xcp.Ev.b);
    xcp.EvLen = 0;
  }
...
{
  Xcp_ConfigPtr->TransportLayer->Transmit(dto->l, &dto->b[0]);
}
  #endif
...
static vuint8 XcpWriteMta( vuint8 size, const BYTEPTR data )
{
  ...
  r = Xcp_ConfigPtr->CalibrationWrite(xcp.Mta, size, data);
...
#if defined ( XCP_ENABLE_CALIBRATION_MEM_ACCESS_BY_APPL ) && !defined ( XCP_ENABLE_MEM_ACCESS_BY_APPL )
  r = Xcp_ConfigPtr->CalibrationRead(xcp.Mta, size, data);
  xcp.Mta += size; /* PRQA S 0488 */ /* MD_Xcp_0488 */
  return r;
#else
...
vuint8 Xcp_Event( vuint8 event )
{
  ...
  /* Data Stimulation (STIM) */
      ...
      for (odt=DaqListFirstOdt(daq);odt<=DaqListLastOdt(daq);odt++)
      {
        ...
        Xcp_ConfigPtr->TransportLayer->EnterCritical(); /* The following code is not reentrant */
        ...
        if ( (DaqListFlags(daq) & (vuint8)DAQ_FLAG_TIMESTAMP) != 0 )
        {
          ...
          {
    #if defined ( XCP_DISABLE_UNALIGNED_MEM_ACCESS )
            t = Xcp_ConfigPtr->TransportLayer->GetTimestamp();
    #endif

    #if defined ( XCP_ENABLE_DAQ_HDR_ODT_DAQ )

            *(XcpDaqTimestampType*)&dtop->b[2] = Xcp_ConfigPtr->TransportLayer->GetTimestamp();
        ...
        #endif
      #else
            *(XcpDaqTimestampType*)&dtop->b[i] = Xcp_ConfigPtr->TransportLayer->GetTimestamp();
...
******************************************************************************/
vuint8 Xcp_Background( void )
{
  vuint32 rxBuf[kXcpMaxCTO / 4U];
  vuint8  rxLen;
  ...
  /* Dequeue and process all pending RX frames */
  while (Xcp_ConfigPtr->TransportLayer->Receive(&rxLen, (BYTEPTR)rxBuf)) {
    Xcp_Command(rxBuf);
  }
...
| DESCRIPTION:      
******************************************************************************/
void Xcp_Command( const vuint32* pCommand )
{
 ...
 /* XCP Data Stimulation Handler */
          ...
          case CC_GET_ID:
            {
              ...
              {
                CRM_GET_ID_LENGTH_WRITE((vuint32)Xcp_ConfigPtr->StationIdLength); /* PRQA S 3109 */ /* MD_MSR_14.3 */
                XcpSetMta( Xcp_ConfigPtr->GetPointer(0xFF, (vuint32)(Xcp_ConfigPtr->StationId)), 0xFF); /* PRQA S 0306 */ /* MD_Xcp_0306 */
              }
          ...
          case CC_SET_CAL_PAGE:
            {
              ...
              check_error( Xcp_ConfigPtr->SetCalPage(CRO_SET_CAL_PAGE_SEGMENT,CRO_SET_CAL_PAGE_PAGE,CRO_SET_CAL_PAGE_MODE) ) /* PRQA S 2001 */ /* MD_Xcp_2001 */
          ...
          case CC_GET_CAL_PAGE:
            {
              ...
              CRM_GET_CAL_PAGE_PAGE = Xcp_ConfigPtr->GetCalPage(CRO_GET_CAL_PAGE_SEGMENT,CRO_GET_CAL_PAGE_MODE);
          ...
          case CC_COPY_CAL_PAGE:
            {
              ...
              err = Xcp_ConfigPtr->CopyCalPage(CRO_COPY_CAL_PAGE_SRC_SEGMENT,CRO_COPY_CAL_PAGE_SRC_PAGE,CRO_COPY_CAL_PAGE_DEST_SEGMENT,CRO_COPY_CAL_PAGE_DEST_PAGE);
...
#endif
              XcpSetMta(Xcp_ConfigPtr->GetPointer(CRO_SET_MTA_EXT,CRO_SET_MTA_ADDR),CRO_SET_MTA_EXT);
...
#endif
              XcpSetMta(Xcp_ConfigPtr->GetPointer(CRO_SHORT_UPLOAD_EXT,CRO_SHORT_UPLOAD_ADDR),CRO_SHORT_UPLOAD_EXT);
      ...
      ( kXcpChecksumMethod == XCP_CHECKSUM_TYPE_CRC32 )
        ...
        ( kXcpChecksumMethod == XCP_CHECKSUM_TYPE_ADD44 )        
  ...
  #endif
                {
                  ...
                  /* Checksum calculation will be performed by Xcp_Background() */
                  goto no_response; /* PRQA S 2001 */ /* MD_Xcp_2001 */
  #endif
                }
              }
            ...
            case CC_GET_DAQ_EVENT_INFO: /* PRQA S 2003 */ /* MD_Xcp_2003 */
              {
                ...
                XcpSetMta( Xcp_ConfigPtr->GetPointer( 0xFF, (vuint32)kXcpEventName[event]), 0xFF ); /* PRQA S 0306 */ /* MD_Xcp_0306 */
  ...
  #endif
              addr = (DAQBYTEPTR)Xcp_ConfigPtr->GetPointer(CRO_WRITE_DAQ_EXT,CRO_WRITE_DAQ_ADDR);
          ...
          case CC_GET_DAQ_CLOCK:
            {
              ...
              /* PRQA S 3757 1 */ /* MD_Xcp_3757 */
              CRM_GET_DAQ_CLOCK_TIME_WRITE((vuint32)Xcp_ConfigPtr->TransportLayer->GetTimestamp()); /* PRQA S 3109 */ /* MD_MSR_14.3 */
...
{
  Xcp_ConfigPtr = ConfigPtr;

  XcpCal_InitWorkingPage();
  XcpCan_Init(ConfigPtr->TransportLayer->CanConfig);
